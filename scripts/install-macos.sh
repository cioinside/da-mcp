...
#   4. Checks Node.js 22+
#   5. Runs npm ci, npm run build, npm test (mock mode)
#   Prints the MCP client config snippet
#
...
step "5/5 Installing dependencies, building, and testing..."
