...
export const SERVER_INSTRUCTIONS = [
  'da-mcp exposes 16 desktop-automation tools over this MCP connection:',
  'da_screenshot, da_ocr, da_list_displays, da_window_list, da_window_focus,',
  'da_get_mouse_position, da_move_mouse, da_click, da_click_text, da_double_click,',
  'da_drag, da_draw_path, da_scroll, da_type, da_key, da_launch.',
